...
PARTICLE_VISCOSITY = {particle_viscosity!r}
PARTICLE_COHESION = {particle_cohesion!r}
PARTICLE_ADHESION = {particle_adhesion!r}
PARTICLE_SURFACE_TENSION = {particle_surface_tension!r}
...
def export_isaac_bundle(
    ...
    script_path.write_text(
        ISAAC_SCRIPT.format(
            ...
            particle_cohesion=material.physx_cohesion,
            particle_adhesion=material.physx_adhesion,
            particle_surface_tension=material.physx_surface_tension,
            particle_friction=material.physx_friction,
