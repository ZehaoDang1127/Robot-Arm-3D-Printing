...
TRAJECTORY_CSV = Path(r"D:\HAIM_Lab\robotic-printing-platform\outputs\robot_print_trajectory.csv")
JOINT_COLUMNS = ["panda_joint1", "panda_joint2", "panda_joint3", "panda_joint4", "panda_joint5", "panda_joint6", "panda_joint7"]
